    ...
    private int calculateLaptopScore(Laptop laptop, int budget, String usage) {
        ...
        switch (usage.toLowerCase()) {
            case "gaming":
                ...
                // High refresh rate
                if (laptop.getRefreshRate() >= 144) score += 15;
                else if (laptop.getRefreshRate() >= 120) score += 10;
                else if (laptop.getRefreshRate() >= 90) score += 5;
                break;
            ...
            case "office":
                ...
                // Lightweight
                if (laptop.getWeightValue() > 0 && laptop.getWeightValue() < 1.5) score += 10;
                break;
